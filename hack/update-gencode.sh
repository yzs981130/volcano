...
${SCRIPT_ROOT}/hack/generate-groups.sh "deepcopy,client,informer,lister" \
  pkg.yezhisheng.me/volcano/pkg/client pkg.yezhisheng.me/volcano/pkg/apis \
...
${SCRIPT_ROOT}/hack/generate-internal-groups.sh "deepcopy,conversion" \
  pkg.yezhisheng.me/volcano/pkg/apis/ pkg.yezhisheng.me/volcano/pkg/apis pkg.yezhisheng.me/volcano/pkg/apis\
  "scheduling:v1beta1"   \
